...
set output "./folded.${output_extension}"
...
set ylabel "Folded Structures Assignement"
...
set title "Folded Structures Assignement against regular MD"
...
set boxwidth 0.2
plot 'folded_dataA.dat'  using (1):2 with boxes ls 	1 ,\
 'folded_dataB.dat'  using (3):2 with boxes		 ls 1 ,\
 'folded_dataC.dat'  using (5):2 with boxes 	 ls 1 ,\
 'folded_dataD.dat'  using (7):2 with boxes  ls     1 , \
 'folded_dataE.dat'  using (9):2 with boxes ls 	    2 , \
 'folded_dataF.dat'  using (11):2 with boxes ls     2 , \
 'folded_dataG.dat'  using (13):2 with boxes ls 	1 , \
 'folded_dataH.dat'  using (15):2 with boxes ls 	1 , \
 'folded_dataI.dat'  using (17):2 with boxes ls 	2 
 
 plot 'folded_dataA.dat'  using (1):3 with boxes ls 1 ,\
 'folded_dataB.dat'  using (3):3 with boxes ls 	 1 ,\
 'folded_dataC.dat'  using (5):3 with boxes ls 	 1 ,\
 'folded_dataD.dat'  using (7):3 with boxes ls 	 1 , \
 'folded_dataE.dat'  using (9):3 with boxes ls 	 2 , \
 'folded_dataF.dat'  using (11):3 with boxes ls 	 2 , \
 'folded_dataG.dat'  using (13):3 with boxes ls 	 1 , \
 'folded_dataH.dat'  using (15):3 with boxes ls 	 1 , \
 'folded_dataI.dat'  using (17):3 with boxes ls 	 2 
